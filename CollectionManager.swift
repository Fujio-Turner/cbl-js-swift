...
public class CollectionManager {
    ...
    // MARK: - Vector Index Functions
    
    /// Creates a vector index on a collection for similarity search.
    /// - Parameters:
    ///   - indexName: The name of the index
    ///   - config: Dictionary containing vector index configuration (expression, dimensions, centroids, etc.)
    ///   - collectionName: The collection name
    ///   - scopeName: The scope name
    ///   - databaseName: The database name
    /// - Throws: VectorIndexError or CollectionError on failure
    public func createVectorIndex(_ indexName: String,
                                  config: [String: Any],
                                  collectionName: String,
                                  scopeName: String,
                                  databaseName: String) throws {
        ...
        do {
            let vectorConfig = try IndexHelper.makeVectorIndexConfiguration(config)
